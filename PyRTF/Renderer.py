...
from .Elements import Table, Cell, Section, RawCode, Paragraph, Image, Text, Inline, TAB, LINE
from .PropertySets import ParagraphPropertySet, TabPropertySet, ShadingPropertySet, BorderPropertySet
...
class Renderer:
    ...
    def _WriteStyleSheet(self):
        ...
        # TODO: character styles, does anybody actually use them?
    ...
    def WriteParagraphElement(self, paragraph_elem, tag_prefix='', tag_suffix=r'\par', opening='{', closing='}'):
        ...
        for element in paragraph_elem:
            if isinstance(element, six.text_type):
                element = element.encode('rtfunicode')
    ...
    def WriteTextElement(self, text_elem):
        ...
        if isinstance(text_elem.Data, six.text_type):
            self._write(text_elem.Data.encode('rtfunicode'))

        elif isinstance(text_elem.Data, six.binary_type):
            self._write(text_elem.Data or b'')
