from types import UnicodeType, StringType, ListType, TupleType, StringTypes
...
class Renderer :
    ...
    def WriteTextElement( self, text_elem ) :
        ...
        if isinstance( text_elem.Data, UnicodeType ) :
            self._write( text_elem.Data.encode('rtfunicode') )

        elif isinstance( text_elem.Data, StringType ) :
