...
from .Constants import Languages, ViewKind
from .PropertySets import (
    AttributedList, Colours, Colour, Fonts, Font, Papers, Paper,
    MarginsPropertySet, TextPropertySet, ParagraphPropertySet, TabPropertySet,
    TabPS, TextPS, ShadingPS, ParagraphPS, FramePS, MarginsPS)
from .Styles import TextStyle, ParagraphStyle
...
StandardColours.append(Colour('Black', 0, 0, 0))  # red green blue
...
class Table:
    ...
    def AddRow(self, *cells):
        height = None
        if isinstance(cells[0], (six.integer_types, float)):
            height = int(cells[0])
            cells = cells[1:]
...
class Cell(list):
    ...
    def __init__(self, *params, **kwargs):
        ...
        for param in params:
            if isinstance(param, six.text_types):
                self.append(param)
