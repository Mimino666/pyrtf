...
def MakeAttributeName(value):
    assert value and isinstance(value, six.text_type)
    value = value.replace(' ', '')
    return value
...
class ParagraphPropertySet:
    ...
    def __init__(self, alignment=None, space_before=None, space_after=None, tabs=None,
                 first_line_indent=None, left_indent=None, right_indent=None, page_break_before=None):
        self.SetAlignment(alignment or self.LEFT)
